# Megogo SQL Workshop — Content & User Behaviour Analysis
...
- Group user interactions by content category and time of day.
- Transform JSON log data into structured analytical fields.
- Calculate user distribution by number of unique watched video objects.
- Refactor analytical queries using CTEs for improved readability.
- Segment users based on viewing behavior:
  - content consumption type (TV / Video / TV+Video),
  - total watch time,
...
- Enable targeted marketing and promotional campaigns.
- Identify valuable user segments for retention initiatives.
- Provide reusable analytical datasets for product and growth analytics.
